...
\KwInput{Dynamics $f$, Initial Parallelotope bundle $Q$, Step Bound $S$, Template Dirs $\Lambda^Q$, Bundle Index Matrix $\T^Q$}
...
$Q_0 \gets Q$ \;
 ...
 \Fun{\TransformBund{$f$, $Q$, $\Lambda$}}{
   ...
   \For{$P \in \ptopeset{Q}$}{
     ...
     $\langle a, g_1, \cdots, g_n \rangle \gets \mathsf{generatorRepresentation}(P)$\;
