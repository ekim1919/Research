...
\end{proof}
%
Corollary \ref{fouriertail} tells us that the probability of the Fourier degree exceeding $s$ decays exponentially with $s$ given that we set our probability parameter to a specific quantity $p = \frac{1}{10^ds^{d-1}}$. This is reminiscent of the familiar Chernoff bounds encountered in
probability theory.
